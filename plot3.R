...
<title>plot3.R · master · WeiHsinChen / Repo · GitLab</title>
...
<meta name="csrf-token" content="mUHq3Ppqn2eVyNt/ZSIW0RsNKrrpDTGx5eizHkK8SpLJbnnB6PsU0g1+zt6BhdPL+3szI/3uF5p+3oPrLZ1utQ==" />
<script>
//<![CDATA[
...
<input type="hidden" name="path" id="path" value="plot3.R" />
</form>
...
<li>
<a href="/WeiHsinChen/Repo/blob/master/plot3.R"><strong>
plot3.R
</strong>
</a></li>
</ul>
...
<a class="btn btn-sm" target="_blank" href="/WeiHsinChen/Repo/raw/master/plot3.R">Raw</a>
<a class="btn btn-sm" href="/WeiHsinChen/Repo/blame/master/plot3.R">Blame</a>
<a class="btn btn-sm" href="/WeiHsinChen/Repo/commits/master/plot3.R">History</a>
<a class="btn btn-sm" href="/WeiHsinChen/Repo/blob/23be6df3bc2e3e4c21e7ac834f37e252d49eadae/plot3.R">Permalink</a>
</div>
